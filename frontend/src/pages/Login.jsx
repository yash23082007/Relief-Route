  ...
  return (
    <div className="min-screen w-screen h-screen flex items-center justify-center bg-[#060813] relative overflow-hidden px-4">
      ...
      <div className="w-full max-w-md bg-[#0a0f1d] border border-slate-800 rounded-2xl p-8 shadow-2xl relative z-10 transition-all">
        ...
        {error && (
          <div className="mb-5 p-3.5 bg-red-950/40 border border-red-900/50 rounded-xl flex items-center space-x-2 text-red-400 text-xs font-mono">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="e.g. command@state.gov"
              required
              className="w-full px-4 py-2.5 bg-slate-900 border border-slate-800 focus:border-indigo-500/80 rounded-xl text-sm text-slate-100 placeholder-slate-600 focus:outline-none transition shadow-inner"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                placeholder="••••••••"
                required
                className="w-full pl-4 pr-10 py-2.5 bg-slate-900 border border-slate-800 focus:border-indigo-500/80 rounded-xl text-sm text-slate-100 placeholder-slate-650 focus:outline-none transition shadow-inner"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-bold font-mono text-xs rounded-xl shadow-lg shadow-indigo-500/20 transition flex items-center justify-center uppercase tracking-wider"
          >
            {loading ? (
        ...
        <div className="mt-6 text-center text-xs text-slate-500 font-sans">
          <span>New disaster response team? </span>
          <Link to="/signup" className="text-indigo-400 font-semibold hover:text-indigo-300 transition underline-offset-4 hover:underline">
