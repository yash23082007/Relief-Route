          ...
          <div className="p-5 space-y-4">
            ...
            <div className="bg-red-950/10 border border-red-900/20 rounded-xl p-4 space-y-3 relative overflow-hidden">
              ...
              <div className="flex items-start space-x-3 relative z-10">
                ...
                <div>
                  <span className="text-[9px] font-bold font-mono text-red-400 uppercase tracking-widest">DETOUR VECTOR</span>
                  <p className="font-bold text-sm text-red-300 mt-0.5 glow-text-red">
                    {ai_directive.recommended_detour}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 border-t border-red-900/10 pt-3 relative z-10">
                ...
                <div>
                  ...
                  <p className="font-bold text-sm text-amber-300 mt-0.5 font-mono">
                    +{ai_directive.estimated_delay_minutes} Minutes Delay
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-1 bg-slate-900/40 border border-slate-800 rounded-xl p-4">
              ...
              <p className="text-xs text-slate-300 leading-relaxed font-sans mt-1">
                {ai_directive.tactical_summary}
              </p>
            </div>
            
            {/* Warning Callout */}
            <p className="text-[9px] text-slate-500 leading-tight">
              ⚠️ Rerouting instructions generated by Gemini disaster model flash-1.5. Always coordinate with localized field reconnaissance before manual implementation.
            </p>
